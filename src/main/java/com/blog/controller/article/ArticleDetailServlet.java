...
////            String fromSearch = request.getParameter("fromSearch"); // 新增：判断是否来自搜索页
////            String keyword = request.getParameter("keyword"); // 新增：搜索关键词
////
...
////
////                // 新增：设置来源信息
////                if ("true".equals(fromSearch) && keyword != null && !keyword.trim().isEmpty()) {
...
////                boolean hasLiked = articleDAO.hasUserLikedArticle(article.getId(), user.getId());
