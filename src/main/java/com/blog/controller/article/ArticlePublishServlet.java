        ...
        if (draftIdStr != null && !draftIdStr.trim().isEmpty()) {
            try {
                ...
                if (draft != null) {
                    ...
                    // 调试日志
                    System.out.println("加载草稿 - ID: " + draftId);
                    System.out.println("草稿标题: " + draft.getTitle());
                    System.out.println("草稿内容长度: " + (draft.getContent() != null ? draft.getContent().length() : 0));
                    System.out.println("草稿内容预览: " + (draft.getContent() != null && draft.getContent().length() > 50 ? 
                        draft.getContent().substring(0, 50) + "..." : draft.getContent()));
