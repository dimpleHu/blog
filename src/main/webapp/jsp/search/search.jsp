                    ...
                    <div class="users-list">
                        <c:forEach items="${searchResults.users}" var="user">
                            <div class="user-card">
                                ...
                                <%
                                    // 处理头像路径
                                    String avatarPath = "/images/avatar/default-avatar.jpg";
                                    String userAvatar = (String) pageContext.getAttribute("userAvatar");
                                    if (userAvatar != null && !userAvatar.trim().isEmpty()) {
                                        avatarPath = userAvatar.startsWith("/") ? userAvatar : "/" + userAvatar;
                                    }
                                %>
                                ...
                                <div class="user-info">
                                    <span class="user-name" style="cursor: default; color: #333; text-decoration: none;">${user.username}</span>
                                    <p class="user-signature">${user.signature != null && !user.signature.isEmpty() ? user.signature : '这个人很懒，什么都没有留下~'}</p>
                                    <div class="user-meta">
